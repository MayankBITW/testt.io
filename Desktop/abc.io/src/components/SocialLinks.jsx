...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mayankyadav01",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@mayank._23",
    icon: Instagram,
    url: "https://www.instagram.com/mayank._23/?hl=en",
    color: "#E4405F",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          <div
            className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-gradient-to-r ${instagram.gradient}`}
          />
